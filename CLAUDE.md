# JOGA+ Academy — Project Brief for Claude
...
- **WhatsApp number used in code:** `+1 (574) 536-1983`
...
> "Read CLAUDE.md. Want me to start with re-deploying the Apps Script, pushing the repo to Vercel, or implementing one of the a–h features? And do you want a `vercel.json` so the form lives at `/apply` instead of `/apply.html`?"
